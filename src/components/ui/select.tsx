...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      // Base layout
      "flex h-10 w-full items-center justify-between gap-2 rounded-xl px-3 py-2 text-sm",
      // Colors — explicit for visibility on any background
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Colors — explicit white background with dark text
